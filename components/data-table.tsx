...
export function DataTable<TData, TValue>({
  ...
  return (
    <>
      <div className="hidden md:block w-full bg-white dark:bg-black/60 p-2 px-5 rounded-lg ">
      ...
      <div className="md:hidden w-full bg-white dark:bg-black/60 p-2 px-5 rounded-lg ">
