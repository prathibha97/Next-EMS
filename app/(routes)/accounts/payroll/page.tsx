          ...
          <div>
            <div>
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <Card className="bg-white drop-shadow-lg bg-[#fbbc08] drop-shadow-none">
                ...
                <Card className="bg-white drop-shadow-lg bg-[#4286f4] drop-shadow-none">
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-semibold text-slate-50">
                      July
                    </CardTitle>
                ...
                <Card className="bg-white drop-shadow-lg bg-[#eb4235] drop-shadow-none">
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-semibold text-slate-50">
                      June
                    </CardTitle>
                ...
                <Card className="bg-white drop-shadow-lg bg-[#34a953] drop-shadow-none">
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-semibold text-slate-50">
                      May
                    </CardTitle>
